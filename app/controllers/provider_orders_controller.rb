...
class ProviderOrdersController < ManageCmrController
  ...
  def show
    ...
    flash[:alert] = "The order request #{request.uuid} timed out showing the order. Please try again or contact Earthdata Support."
  ...
  def edit
    ...
    flash[:alert] = "The order request #{request.uuid} timed out editing the order. Please try again or contact Earthdata Support."
    redirect_to orders_path
  end
  ...
  def destroy
    ...
    flash[:alert] = "The order request #{request.uuid} timed out deleting the order. Please try again or contact Earthdata Support."
    redirect_to orders_path
  end
  ...
  def resubmit
    ...
    flash[:alert] = "The order request #{request.uuid} timed out resubmitting order. Please try again or contact Earthdata Support."
    redirect_to orders_path
  end
