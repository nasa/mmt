class SystemIdentityPermissionsController < ManagePermissionsController
  ...
  #     # TODO: remove concept id. clean up hash, only need assembled_permissions[target] = granted_permissions
  ...
  #         # removing permissions to the target, need to remove the group from the system acl
  ...
  #       # TODO:  add logging for update success
  #       successes << target
  #     else
  ...
  #       # TODO: add logging for permission creation
  ...
  #       # TODO: add logging for permission deletion
  #       successes << target
  #     else
