module PreviewCirclesHelper
  ...
  def empty_circle(field, draft, form_name, anchor, required)
    ...
    link_to "<i class=\"#{icon}\"></i> <span class=\"is-invisible\">#{text}</span>".html_safe, draft_edit_form_path(draft, form_name, anchor: anchor), title: field
  end
  ...
  def invalid_circle(field, draft, form_name, anchor)
    link_to "<i class=\"ed-icon ed-fa-minus-circle icon-red\"></i> <span class=\"is-invisible\">#{field} Invalid</span>".html_safe, draft_edit_form_path(draft, form_name, anchor: anchor), title: field
  end
end
