  ...
  url_content_type: [{
    ...
    type: [{
      ...
      subtype: [{
        ...
        value: 'ALGORITHM THEORETICAL BASIS DOCUMENT (ATBD)',
        ...
        value: 'INSTRUMENT/SENSOR CALIBRATION DOCUMENTATION',
        uuid: 'fc3c1abb-92c1-49c2-90d4-161c70cff44a'
      }, {
        value: 'SCIENCE DATA PRODUCT SOFTWARE DOCUMENTATION',
    ...
    type: [{
      value: 'Color Map',
      uuid: '58848eb9-9c2c-491e-847e-5a4f3d9f6889',
      subfields: ['subtype'],
      subtype: [{
        value: 'Giovanni',
        uuid: '197d7881-a01b-4892-822f-94ca72aea2f4'
      }, {
        value: 'Harmony GDAL',
        uuid: '503206c2-c5ae-4d65-8c18-be8d06370c0c'
      }, {
        value: 'GITC',
        uuid: '87117fb4-888c-41b9-a795-d13d436d828b'
      }]
    }, {
      ...
      subtype: [{
        ...
        value: 'GIS',
        uuid: 'efbd1edc-388f-4985-8033-6782ee87d463'
      }, {
        value: 'MAP',
    ...
    type: [{
      ...
      subtype: [{
        ...
        value: 'MLHub',
        uuid: '7ff3e5a8-650a-4cd1-80db-cca0fd209a84'
      }, {
        value: 'MODAPS',
