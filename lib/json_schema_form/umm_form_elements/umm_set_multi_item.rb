...
class UmmSetMultiItem < UmmMultiItem
  ...
  # The parent implementation of element_data does not account of terminal '/items'
  # in full_key that only occur in set_multi_items like ValidRanges and IndexRanges
  # in UMM-V 1.7
  def element_data
    options['data']
