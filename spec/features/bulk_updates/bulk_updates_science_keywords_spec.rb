describe 'Bulk updating Science Keywords' do
  ...
  context 'when previewing a Find & Remove bulk update', js: true do
    let(:bulk_update_name) { "Bulk Update Science Keywords Test Find & Remove #{Faker::Number.number(digits: 3)}" }
  ...
  context 'when previewing a Add to Existing bulk update', js: true do
    let(:bulk_update_name) { "Bulk Update Science Keywords Test Add to Existing #{Faker::Number.number(digits: 3)}" }
  ...
  context 'when previewing a Find & Replace bulk update', js: true do
    let(:bulk_update_name) { "Bulk Update Science Keywords Test Find & Replace #{Faker::Number.number(digits: 3)}" }
  ...
  context 'when previewing a Clear All and Replace bulk update', js: true do
    let(:bulk_update_name) { "Bulk Update Science Keywords Test Clear All and Replace #{Faker::Number.number(digits: 3)}" }
