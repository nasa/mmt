  ...
  context 'When examining the Variable Characteristics section' do
    it 'displays the stored values correctly within the preview' do
      within '.umm-preview.variable_characteristics' do
        ...
        within '#variable_characteristics_chunk_size_preview' do
          expect(page).to have_css('h5', text: 'Chunk Size')

          expect(page).to have_css('p', text: '100.0')
        end

        within '#variable_characteristics_structure_preview' do
        ...
        within '#variable_characteristics_measurement_conditions_preview' do
        ...
        within '#variable_characteristics_reporting_conditions_preview' do
