describe 'Valid Variable Variable Information Preview', reset_provider: true do
  before do
    ...
    ingest_response, _concept_response = publish_variable_draft(name: 'PNs_LIF', long_name: 'Volume mixing ratio of sum of peroxynitrates in air', collection_concept_id: ingest_collection_response['concept-id'])
