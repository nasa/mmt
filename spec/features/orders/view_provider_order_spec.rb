...
describe 'Viewing Provider Order Information' do
  ...
  context 'when viewing provider order information' do
    ...
    it 'displays order information' do
      ...
      # Receipt
      expect(page).to have_content('Acceptance Date: 2017-02-03T15:20:43.033Z')
      expect(page).to have_content('Estimated Ship Date: 2017-02-03T15:20:43.026Z')
      expect(page).to have_content('Last Cancel Date: 2017-02-03T15:20:43.026Z')
    end
