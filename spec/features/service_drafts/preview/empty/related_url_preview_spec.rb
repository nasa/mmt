  ...
  it 'displays the stored values correctly within the preview' do
    within '.umm-preview.related_url' do
      ...
      within '#service_draft_draft_name_preview' do
        ...
        expect(page).to have_link(nil, href: edit_service_draft_path(service_draft, 'related_url', anchor: 'service_draft_draft_name'))
      ...
      within '#service_draft_draft_long_name_preview' do
        ...
        expect(page).to have_link(nil, href: edit_service_draft_path(service_draft, 'related_url', anchor: 'service_draft_draft_long_name'))
      ...
      within '#service_draft_draft_type_preview' do
        ...
        expect(page).to have_link(nil, href: edit_service_draft_path(service_draft, 'related_url', anchor: 'service_draft_draft_type'))
      ...
      within '#service_draft_draft_version_preview' do
        ...
        expect(page).to have_link(nil, href: edit_service_draft_path(service_draft, 'related_url', anchor: 'service_draft_draft_version'))
      ...
      within '#service_draft_draft_description_preview' do
        ...
        expect(page).to have_link(nil, href: edit_service_draft_path(service_draft, 'related_url', anchor: 'service_draft_draft_description'))
