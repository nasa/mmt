          ...
          within all('li.card')[0] do
            ...
            within all('.card-body')[0] do
              within '.card-body-details' do
                ...
                expect(page).to have_content('This service organization does not have any addresses listed.')
              end
              within '.card-body-aside' do
                expect(page).to have_content('This service organization does not have any contact mechanisms listed.')
              end
            end
          end
        end
