...
describe 'Invalid Service Draft Acquisition Information Preview' do
  ...
  it 'displays the corrent status icon' do
    within '#acquisition_information-progress' do
      within '.status' do
        expect(page).to have_content('Acquisition Information is incomplete')
      end
    end
  end
  ...
  it 'displays the correct progress indicators for non required fields' do
    within '#acquisition_information-progress .progress-indicators' do
      expect(page).to have_css('.eui-icon.eui-fa-minus-circle.icon-red.platforms')
    end
  end
end
