    ...
    context 'when examining the metadata preview section' do
      it 'displays links to edit/update the data' do
        within '.umm-preview.sampling_identifiers' do
          ...
          expect(page).to have_link(nil, href: edit_variable_draft_path(variable_draft, 'sampling_identifiers', anchor: 'variable_draft_draft_sampling_identifiers_0_sampling_method'))
          expect(page).to have_link(nil, href: edit_variable_draft_path(variable_draft, 'sampling_identifiers', anchor: 'variable_draft_draft_sampling_identifiers_0_measurement_conditions'))
          expect(page).to have_link(nil, href: edit_variable_draft_path(variable_draft, 'sampling_identifiers', anchor: 'variable_draft_draft_sampling_identifiers_0_reporting_conditions'))
          expect(page).to have_link(nil, href: edit_variable_draft_path(variable_draft, 'sampling_identifiers', anchor: 'variable_draft_draft_sampling_identifiers_1_sampling_method'))
          expect(page).to have_link(nil, href: edit_variable_draft_path(variable_draft, 'sampling_identifiers', anchor: 'variable_draft_draft_sampling_identifiers_1_measurement_conditions'))
          expect(page).to have_link(nil, href: edit_variable_draft_path(variable_draft, 'sampling_identifiers', anchor: 'variable_draft_draft_sampling_identifiers_1_reporting_conditions'))
        end
      end
