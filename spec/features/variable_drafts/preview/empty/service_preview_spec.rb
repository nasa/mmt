...
describe 'Empty Variable Draft Service Preview' do
  ...
  context 'When examining the Service section' do
    it 'displays the form title as an edit link' do
      within '#services-progress' do
        expect(page).to have_link('Services', href: edit_variable_draft_path(@draft, 'services'))
      end
    end
    ...
    it 'displays the stored values correctly within the preview' do
      within '.umm-preview.services' do
        ...
        within '#variable_draft_draft_services_preview' do
          ...
          expect(page).to have_link(nil, href: edit_variable_draft_path(@draft, 'services', anchor: 'variable_draft_draft_services'))
