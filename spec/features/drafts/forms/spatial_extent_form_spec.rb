...
describe 'Spatial extent form', js: true do
  ...
  context 'when submitting the form with vertical spatial' do
    ...
    it "shows pre-entered values in the draft preview page" do
      ...
      expect(page).to have_content('Resolution: 3')
      expect(page).to have_content('Resolution: 3 4')
      ...
      expect(page).to have_content('Resolution: 5')
      expect(page).to have_content('Resolution: 5 6')
    end
