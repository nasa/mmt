describe CollectionDraft do
  ...
  it '`update_draft` overwrites old values with new values' do
    ...
    expect(collection_draft.draft).to eq('EntryTitle' => 'new title', 'MetadataSpecification' => { 'Name' => 'UMM-C', 'URL' => 'https://cdn.earthdata.nasa.gov/umm/collection/v1.17.0', 'Version' => '1.17.0' })
  end
  it '`update_draft` deletes empty values' do
    ...
    expect(collection_draft.draft).to eq('ShortName' => '12345', 'MetadataSpecification' => { 'Name' => 'UMM-C', 'URL' => 'https://cdn.earthdata.nasa.gov/umm/collection/v1.17.0', 'Version' => '1.17.0' })
  end
  it '`update_draft` converts number fields to numbers' do
    ...
    expect(collection_draft.draft).to eq('Size' => 42.0, 'MetadataSpecification' => { 'Name' => 'UMM-C', 'URL' => 'https://cdn.earthdata.nasa.gov/umm/collection/v1.17.0', 'Version' => '1.17.0' })
  end
  it '`update_draft` converts number fields with delimiters to numbers' do
    ...
    expect(collection_draft.draft).to eq('Size' => 9001.0, 'MetadataSpecification' => { 'Name' => 'UMM-C', 'URL' => 'https://cdn.earthdata.nasa.gov/umm/collection/v1.17.0', 'Version' => '1.17.0' })
  end
  it '`update_draft` converts integer fields to integers' do
    ...
    expect(collection_draft.draft).to eq('NumberOfInstruments' => 42, 'MetadataSpecification' => { 'Name' => 'UMM-C', 'URL' => 'https://cdn.earthdata.nasa.gov/umm/collection/v1.17.0', 'Version' => '1.17.0' })
  end
  it '`update_draft` converts boolean fields to boolean' do
    ...
    expect(collection_draft.draft).to eq('EndsAtPresentFlag' => false, 'MetadataSpecification' => { 'Name' => 'UMM-C', 'URL' => 'https://cdn.earthdata.nasa.gov/umm/collection/v1.17.0', 'Version' => '1.17.0' })
  end
  ...
  it 'sets the MetadataSpecification after the collection draft has been saved' do
    ...
    expect(metadata_specification['URL']).to eq('https://cdn.earthdata.nasa.gov/umm/collection/v1.17.0')
    expect(metadata_specification['Name']).to eq('UMM-C')
    expect(metadata_specification['Version']).to eq('1.17.0')
  end
  ...
  it '`create_from_collection` saves the draft' do
    collection = { 'ShortName' => '12345', 'EntryTitle' => 'test title', 'MetadataSpecification' => { 'Name' => 'UMM-C', 'URL' => 'https://cdn.earthdata.nasa.gov/umm/collection/v1.17.0', 'Version' => '1.17.0' }}
    user = User.create(urs_uid: 'testuser', provider_id: 'MMT_2')
    native_id = 'test_id'
    collection_draft = CollectionDraft.create_from_collection(collection, user, native_id)
