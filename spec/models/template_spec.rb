...
describe Template do
  ...
  # create_collection_template method
  it '"create_collection_template" saves the name' do
    ...
    name = 'Test Template'
    template = Template.create_collection_template(collection_draft, user, name)

    expect(template.title).to eq(name)
  end
  it '"create_collection_template" saves the user' do
    draft = { 'TestField1' => 'test value1', 'TestField2' => 'test value2' }
    collection_draft = CollectionDraft.create(draft: draft, entry_title: 'Example Entry Title')
    user = User.create(urs_uid: 'testuser', provider_id: 'MMT_2')
    name = 'Test Template'
  ...
  it '"create_collection_template" saves the entry title' do
    draft = { 'TestField1' => 'test value1', 'TestField2' => 'test value2' }
    collection_draft = CollectionDraft.create(draft: draft, entry_title: 'Example Entry Title')
    user = User.create(urs_uid: 'testuser', provider_id: 'MMT_2')
    name = 'Test Template'
  ...
  it '"create_collection_template" saves the draft' do
    draft = { 'TestField1' => 'test value1', 'TestField2' => 'test value2' }
    collection_draft = CollectionDraft.create(draft: draft, entry_title: 'Example Entry Title')
    user = User.create(urs_uid: 'testuser', provider_id: 'MMT_2')
    name = 'Test Template'
