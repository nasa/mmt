module Helpers
  module SubscriptionsHelpers
    def prepare_subscription_permissions(permissions, provider = 'MMT_2',token= 'access_token')
      ActiveSupport::Notifications.instrument 'mmt.performance', activity: 'Helpers::SubscriptionsHelpers#prepare_subscription_permissions' do
        ...
        permission_response = add_permissions_to_group(group_response['group_id'], permissions, 'SUBSCRIPTION_MANAGEMENT', provider, token)
