...
template_path = 'shared/preview/_organizations.html.erb'

describe template_path, type: :view do
  context 'when the organizations data' do
    before do
    ...
    context 'is empty' do
      ...
      it 'does not crash or have organizations data' do
        expect(rendered).to have_content('Organizations')
    ...
    context 'is populated' do
      ...
      it 'shows the values in the correct places and formats in the draft preview page' do
        ...
        root_css_path = 'ul.organizations-preview'
