describe Proposal::CollectionDraftProposalsController do
  it 'shows draft collection proposal record for proposal mode' do
    ...
    allow_any_instance_of(Cmr::UrsClient).to receive(:validate_dmmt_token).and_return(Cmr::Response.new(Faraday::Response.new(status: 200, body: '{"uid":"testuser"}', response_headers: {})))
