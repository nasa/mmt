FactoryGirl.define do
  ...
  factory :invalid_service_draft, class: ServiceDraft do
    ...
    draft {{
      'Name': draft_short_name || "#{Faker::Books::Dune.title}_#{Faker::Number.number(digits: 90)}",
      'LongName': draft_entry_title || "#{Faker::Books::Dune.saying.truncate(1000, omission: '')}_#{Faker::Number.number(digits: 1100)}",
      'Type': 'INVALID',
  ...
  factory :full_service_draft, class: ServiceDraft do
    ...
    draft {{
      'Name': draft_short_name || "#{Faker::Books::Dune.title.truncate(10, omission: '')}_#{Faker::Number.number(digits: 9)}",
      'LongName': draft_entry_title || "#{Faker::Books::Dune.saying.truncate(100, omission: '')}_#{Faker::Number.number(digits: 19)}",
      'Type': 'NOT PROVIDED',
      'Version': '1.0',
