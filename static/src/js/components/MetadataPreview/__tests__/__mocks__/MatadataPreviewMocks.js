...
export const mockCollectionDraft = {
...
export const mockServiceDraft = {
  ...
  providerId: 'MMT_2',
  revisionDate: '2024-04-29T21:04:54.029Z',
  revisionId: '1',
  ummMetadata: {
    Name: 'Service Draft Preview Test',
...
export const mockVariableDraft = {
  ...
  providerId: 'MMT_2',
  revisionDate: '2024-04-26T14:24:48.746Z',
  revisionId: '1',
  ummMetadata: {
