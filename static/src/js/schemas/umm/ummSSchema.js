const ummSSchema = {
  ...
  definitions: {
    ...
    SubsetType: {
      ...
      anyOf: [{
        required: ['SpatialSubset']
      }, {
        required: ['TemporalSubset']
      }, {
        required: ['VariableSubset']
      }]
    },
    SpatialSubsetType: {
      description: 'This element describes what kind of spatial subsetting the service provides. The sub elements provide the details.',
    ...
    SpatialSubsetShapefileType: {
      ...
      type: 'array',
      items: { $ref: '#/definitions/SpatialSubsetShapefileInformationType' },
      minItems: 1
    },
    ...
    SupportedReformattingsPairType: {
      ...
      required: ['SupportedInputFormat', 'SupportedOutputFormats']
    },
    SupportedProjectionType: {
      ...
      properties: {
        ...
        ProjectionDatumName: {
          ...
          type: 'string',
          enum: ['North American Datum (NAD) 1927', 'North American Datum (NAD) 1983', 'World Geodetic System (WGS) 1984']
        }
      }
    },
    VariableAggregationTypeEnum: {
      description: 'This element is used to identify the list of supported methods of variable aggregation.',
      type: 'string',
      enum: ['AVG', 'COUNT', 'SUM', 'MIN', 'MAX', 'VAR', 'ANOMOLY']
    },
    InterpolationTypeEnum: {
      description: 'This element is used to identify the interpolation type of the variable.',
      type: 'string',
      enum: ['Bilinear Interpolation', 'Bicubic Interpolation', 'Distance-weighted average resampling', 'Nearest Neighbor', 'Elliptical Weighted Averaging']
    },
    SupportedFormatTypeEnum: {
      description: 'This element contains a list of file formats supported by the service.',
      type: 'string',
      enum: ['HDF4', 'HDF5', 'HDF-EOS', 'HDF-EOS2', 'HDF-EOS5', 'NETCDF-3', 'NETCDF-4', 'GEOTIFF', 'GEOTIFFINT16', 'GEOTIFFFLOAT32', 'XML', 'ASCII', 'BINARY', 'ICARTT', 'PNG', 'JPEG', 'GIF', 'TIFF', 'XLSX', 'JSON', 'CSV', 'KML', 'PNG24', 'BMP', 'ZARR', 'Shapefile', 'Shapefile+zip', 'GeoJSON', 'COG', 'WKT']
    },
    URLType: {
      type: 'object',
      additionalProperties: false,
    ...
    OperationMetadataType: {
      ...
      properties: {
        OperationName: {
          ...
          type: 'string',
          enum: ['GetCapabilities', 'DescribeCoverage', 'GetCoverage', 'GetMap', 'GetLegendGraphic', 'GetTile', 'GetFeatureInfo', 'DescribeFeatureType', 'GetPropertyValue', 'GetFeature', 'GetFeatureWithLock', 'LockFeature', 'Transaction', 'CreateStoredQuery', 'DropStoredQuery', 'ListStoredQueries', 'DescribeStoredQueries', 'SPATIAL_SUBSETTING', 'TEMPORAL_SUBSETTING', 'VARIABLE_SUBSETTING', 'VARIABLE_AGGREGATION']
        },
    ...
    DataResourceType: {
      ...
      properties: {
        ...
        DataResourceSourceType: {
          ...
          type: 'string',
          enum: ['Map', 'Variable', 'Granule', 'Collection', 'Virtual']
        },
        ...
        SpatialResolutionUnit: {
          ...
          type: 'string',
          enum: ['Meters', 'KM', 'Degrees', 'Degrees_North', 'Degrees_East']
        },
        ...
        TemporalResolutionUnit: {
          ...
          type: 'string',
          enum: ['DAY', 'TWICE_PER_DAY', 'WEEK', 'MONTH', 'YEAR']
        },
        RelativePath: {
    ...
    ParameterType: {
      ...
      required: ['ParameterName', 'ParameterDescription', 'ParameterDirection', 'ParameterOptionality', 'ParameterRepeatability']
    },
    CoordinatesType: {
      type: 'object',
      additionalProperties: false,
    ...
    ExtentType: {
      ...
      required: ['LowerBound', 'UpperBound', 'UOMLabel']
    },
    ...
    CRSIdentifierTypeEnum: {
      ...
      type: 'string',
      enum: ['EPSG:4326', 'EPSG:3395', 'EPSG:3785', 'EPSG:9807', 'EPSG:2000.63', 'EPSG:2163', 'EPSG:3408', 'EPSG:3410', 'EPSG:6931', 'EPSG:6933', 'EPSG:3411', 'EPSG:9822', 'EPSG:54003', 'EPSG:54004', 'EPSG:54008', 'EPSG:54009', 'EPSG:26917', 'EPSG:900913', 'Other']
    },
    DataResourceTemporalTypeEnum: {
      description: 'The temporal extent of the layer, feature type or coverage available from the service.',
      type: 'string',
      enum: ['TIME_STAMP', 'TIME_RANGE', 'TIME_SERIES', 'TIME_AVERAGE']
    },
    CouplingTypeEnum: {
      ...
      type: 'string',
      enum: ['LOOSE', 'MIXED', 'TIGHT']
    },
    DistributedComputingPlatformTypeEnum: {
      description: 'This element contains the distributed computing platform (protocol) for the operation(s) made possible via this service.',
      type: 'string',
      enum: ['XML', 'CORBA', 'JAVA', 'COM', 'SQL', 'SOAP', 'Z3950', 'HTTP', 'HTTPS', 'FTP', 'WEBSERVICES']
    },
