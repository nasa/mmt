  ...
  MeasurementIdentifiers: {
    ...
    items: {
      ...
      'ui:controlled': {
        ...
        map: {
          MeasurementContextMedium: 'context_medium',
                  ...
                  'ui:row': [
                    {
                      'ui:col': {
                        md: 12,
                        controlName: 'context_medium',
                        children: ['MeasurementContextMedium']
                      }
                    }
                  ]
                },
                  ...
                  'ui:row': [
                    {
                      'ui:col': {
                        md: 12,
                        children: ['MeasurementContextMediumURI']
                      }
                    }
                  ]
                },
                  ...
                  'ui:row': [
                    {
                      'ui:col': {
                        md: 12,
                        children: ['MeasurementQuantities']
                      }
                    }
                  ]
                }
                      ...
                      'ui:row': [
                        {
                          'ui:col': {
                            md: 12,
                            children: ['MeasurementQuantityURI']
                          }
                        }
                      ]
                    }
