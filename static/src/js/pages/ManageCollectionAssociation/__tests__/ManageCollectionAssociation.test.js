  ...
  render(
    ...
    >
      <NotificationsContext.Provider value={notificationContext}>
        <MemoryRouter initialEntries={overrideInitialEntries || ['/tools/TL1200000-TEST/collection-association']}>
          <MockedProvider
...
describe('ManageCollectionAssociation', () => {
  describe('when the collection association page is requested', () => {
    test('renders the collection association page with the associated collections', async () => {
      ...
      expect(screen.getByText('Associated Collection 1')).toBeInTheDocument()
      expect(screen.getByText('Associated Collection 2')).toBeInTheDocument()
    })
  })
