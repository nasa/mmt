Rails.application.routes.draw do
  ...
  get '/variable_drafts/:id.:format' => 'variable_drafts#show_json', :constraints => {:format => "json"}
  ...
  get '/service_drafts/:id.:format' => 'service_drafts#show_json', :constraints => {:format => "json"}
  ...
  get '/collection_drafts/:id.:format' => 'collection_drafts#show_json', :constraints => {:format => "json"}
